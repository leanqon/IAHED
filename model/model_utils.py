...
def create_vocab(file):
    with open (f'./data/dict{args.data_name}/'+file, 'rb') as fp:
...
def init(data_name,diag_flag,proc_flag,out_flag,chart_flag,med_flag,lab_flag,anti_flag,vent_flag):
        condVocabDict={}
        procVocabDict={}
        medVocabDict={}
        outVocabDict={}
        ...
        with open(f'./data/dict{data_name}/'+'ethVocabDict', 'wb') as fp:
            pickle.dump(ethVocabDict, fp)
            
        ageVocabDict=create_vocab('ageVocab')
        with open(f'./data/dict{data_name}/'+'ageVocabDict', 'wb') as fp:
            pickle.dump(ageVocabDict, fp)
        
        genderVocabDict=gender_vocab()
        with open(f'./data/dict{data_name}/'+'genderVocabDict', 'wb') as fp:
            pickle.dump(genderVocabDict, fp)
            
        insVocabDict=create_vocab('insVocab')
        with open(f'./data/dict{data_name}/'+'insVocabDict', 'wb') as fp:
        ...
        return len(condVocabDict),len(procVocabDict),len(medVocabDict),len(outVocabDict),len(chartVocabDict),len(labVocabDict),len(antiVocabDict),len(ventVocabDict),condVocabDict,procVocabDict,medVocabDict,outVocabDict,chartVocabDict,labVocabDict,antiVocabDict,ventVocabDict,ethVocabDict,genderVocabDict,ageVocabDict,insVocabDict

    
def init_read(data_name,diag_flag,proc_flag,out_flag,chart_flag,med_flag,lab_flag,anti_flag,vent_flag):#batch_size,
        condVocabDict={}
        procVocabDict={}
        medVocabDict={}
        outVocabDict={}
        ...
        return len(condVocabDict),len(procVocabDict),len(medVocabDict),len(outVocabDict),len(chartVocabDict),len(labVocabDict),len(antiVocabDict),len(ventVocabDict),len(ethVocabDict),len(genderVocabDict),len(insVocabDict),condVocabDict,procVocabDict,medVocabDict,outVocabDict,chartVocabDict,labVocabDict,antiVocabDict,ventVocabDict,ethVocabDict,genderVocabDict,ageVocabDict,insVocabDict
